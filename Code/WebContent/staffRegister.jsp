  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link scrollto active" href="Faculty.jsp">Back</a></li>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="well-left">
              <div class="single-well">
                <a href="#"><br>
                <center><strong><h4 style="color:black;">STAFF REGISTER</h4></strong></center>
                </a>
            ...
            <input type="text" name="name" class="form-control" id="name"  placeholder="Enter Your Name" required><br>
             ...
             <select type="text" name="gender" class="form-control custom-labels" id="gender" placeholder="Select Gender">
				...
				<input type="text" name="designation" class="form-control custom-labels" placeholder="Designation"><br>
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="well-middle">
              <div class="single-well">
                <a href="#"><br><br><br><br>
                <img src="assets/img/staffreg.jpg" alt="">
                   </a>
                <!-- <p>
