    ...
    <div class="hero-container">
      ...
      <!--   <ol id="hero-carousel-indicators" class="carousel-indicators"></ol> -->
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background-image:url(assets/img/stf.jpg)">
          
          <div class="carousel-container">
              <div class="container">
        
          <div class="text-center" style="color:blue" > <h2><strong><u> All Staff Details:</u></strong></h2></div>
 

<div class="text-center" ><input type='text' id='txt_searchall' placeholder='Enter search text'>&nbsp; </div>
                    ...
                    //while(rs.next())
                     if(rs.next() == false) {
                    	...
                    	<td style="color:black"><%=rs.getString(9) %></td> 
                    	 ...
                    	 <th><a href="StatusServlet?id=<%=rs.getInt(1)%>&status=<%=rs.getString(7)%>"><%=rs.getString(7)%></a></th>  
