  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link scrollto active" href="studentHome.jsp">Back</a></li>
...
<br><br><br><br>
          <div class="carousel-item active" style="background-image:url(assets/img/leave123.jpg)">
     ...
     <!--  <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="icon-box" data-aos="fade-up">
             <h4 style="color:#282852">Student Leave Application</h4><br>
                 <form action="StuLveServlet" method="post" enctype="multipart/form-data">
