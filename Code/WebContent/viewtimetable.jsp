          ...
          <a style="color:white;"><img src="assets/img/user.png" alt=""  class="rounded-circle"><%response.setContentType("text/html");  
				 HttpSession sessio=request.getSession(true);  
	               ...
	               String email=(String)session.getAttribute("email");  
	                out.print(" "+email+""); } %></a>
	                <ul><li class="dropdown"><a class="nav-link scrollto" href="index.jsp" style="color:black;">Logout</a></li></ul>
  ...
  <main id="main">
    ...
    <div id="about" class="about-area area-padding">
      <div class="container">
       ...
       <br> <br> <br> <br> <br>
 <center><h2><strong> Timetable Details:</strong></h2></center>
<!-- <input type='text' id='txt_searchall' placeholder='Enter search text'>&nbsp; --> 
    ...
    <center><table width='80%' border='1' style='border-collapse:collapse;'></center>
 ...
 <!--  <table class="table table-bordered" style="color:black border-spacing:0 5px;" > -->
  ...
  <%
                    ...
                    //while(rs.next())
                     if(rs.next() == false) {
                    	%>
                    	<h6 style="text-align:right;margin-right:10px"  width="50px" height="50px"><b>No Users Present</b></h6>
                    	<%
                     }
                    else{
                    	int count=0;
                    	do{	 
                    	 ...
                    	 <tr class="header" style="color:blue" margin-left="10px">
                    	 <!--  <th>id</th> -->
		                   <th >Course_id</th> 
		                   <th>Course Name</th>
		                      <th>year</th>
		                  ...
		                  <%}%>
                    	 <tr>
                    	<%--  <td><img alt="Profile Pic" class="img-circle" src="newfacProfile.jsp?id=<%=rs.getInt(1) %>"  width="100px" height="80px"/></td>  --%>
                     ...
                     <td style="color:black"><%=rs.getString(13) %></td>  --%>
                    	...
                    	<%--  <th><a href="statusAttendance?id=<%=rs.getInt(1)%>&status=<%=rs.getString(9)%>"><%=rs.getString(9)%></a></th> --%> 
                    	...
                    	<%--  <td><button  type="button" class="btn btn-danger"><a href="DeleteServlet?id=<%=rs.getInt(1)%>"><b>Delete</b></a></button></td> --%>
                    	 </tr>                  	 
                    <%count++; }while(rs.next());}%> 
