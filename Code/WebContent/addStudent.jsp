          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="well-left">
              <div class="single-well">
                <a href="#"><br>
                <center><strong><h4 style="color:black;">ADD STUDENT</h4></strong></center>
                </a>
                 <form action="newFacultyServlet" method="post">
           
          
            <input type="text" name="name" class="form-control" id="name"  placeholder="Enter New Student Name" required><br>
              ...
              <input type="text" name="rollno" class="form-control" id="rollno"  placeholder="Enter Your rollno" required><br>
		...
		<input type="text" name="" class="form-control" id="phoneno"  placeholder="Enter Your address" required><br>  -->
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="well-middle">
              <div class="single-well">
                <a href="#"><br><br><br><br>
                <img src="assets/img/faculty1.jpg" alt="">
                   </a>
                <!-- <p>
