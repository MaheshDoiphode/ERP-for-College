  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link scrollto active" href="Student.jsp">Back</a></li>
           <li><a class="nav-link scrollto active" href="home.jsp">Logout</a></li>
         <!--  <li><a class="nav-link scrollto" href="userLogin.jsp">User</a></li>
          <li><a class="nav-link scrollto" href="mechanic.jsp">Mechanic</a></li>
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="well-left">
              <div class="single-well">
                <a href="#">
                <center><strong><h4 style="color:black;">STUDENT REGISTER</h4></strong></center>
                </a>
                 <form action="StudentRegServlet" method="post">
           
          
            <input type="text" name="name" class="form-control" id="name"  placeholder="Enter Your Name" required><br>
             <input type="text" name="contactno" class="form-control" id="contactno"  placeholder="Enter Your Contact No" required><br>
              <input type="text" name="address" class="form-control" id="address"  placeholder="Enter Your address" required><br> 
             <select type="text" name="gender" class="form-control custom-labels" id="gender" placeholder="Select Gender">
											<option style="background-color: white">Select Gender</option>
											<option style="background-color: white">Male</option>
											<option style="background-color: white">Female</option>
		</select><br>
		
										
											<select type="text" name="branch" class="form-control" id="branch" placeholder="Branch">
											<option style="background-color: white">Select Branch</option>
											...
											<option style="background-color: white">Select Year</option>
				 ...
				 <!-- <input type="text" name="dob" class="form-control" id="dob"   placeholder="enter your date of birth" required><br>	 -->					
				 <input type="text" name="email" class="form-control" id="email"   placeholder="abc@gmail.com" required><br>					
				<input type="text" name="prnno" class="form-control"  title="Enter 8 digit and 1 Capital alphabet (eg.71540778G)" placeholder="PRN Number" /><br>
										
            <!--  <input type="text" name="" class="form-control" id=""  placeholder="Enter Your Phoneno" required><br> -->
           
            <input type="text" name="rollno" class="form-control" id="rollno"   placeholder="enter your roll no" required><br>
            <input type="password" name="pass" class="form-control" id="pass"   placeholder="enter password" required required pattern="^\d{8}$" title="10 numeric characters only"><br>
            <br><div class="text-center">
                <button class="button" button name="submit"  type="submit" value="submit">Submit</button>
                    <!-- <button class="button" button name="reset"  type="reset" >Cancel</button><br><br> -->
                  <!--  <p ><b><i>Already Exist Account?</b><a href="studentLogin.jsp" style="color:#444;">Click On Login</a></i></p> -->
