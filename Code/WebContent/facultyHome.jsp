  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link scrollto active" href="facultyHome.jsp">Home</a></li>
            ...
            <ul>
             <!--  <li><a href="#">Drop Down 1</a></li> -->
              <!-- <li class="dropdown"><a href="#"><span>All Books</span></a> -->
                 <li><a href="staffleave.jsp">Add Leave Request</a></li>
                   <li><a href="addStuAttend.jsp">Add Student Attendance</a></li>
          ...
          <li class="dropdown"><a href="Student.jsp" class="img-fluid"><img src="assets/img/bg.png" alt="" ><span>Notification</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
             <!--  <li><a href="#">Drop Down 1</a></li> -->
              <!-- <li class="dropdown"><a href="#"><span>All Books</span></a> -->
                 <li><a href="ViewFacultyLeave.jsp">View leave  details</a></li>
                 <li><a href="viewnotice.jsp">View notice details</a></li>
                
                    <li><a href="viewtimetable.jsp">View timetable details</a></li>
                      <li><a href="viewsubjectassign.jsp">View subject assign details</a></li>
                       <li><a href="viewstuleave.jsp">View Student leave  Request</a></li>
                <!--  <li><a href="studleave.jsp">View fine d</a></li> -->
                <!--  <li><a href="studleave.jsp">View attendance</a></li> -->
            </ul>
          </li>
...
<br><br><br><br>
          <div class="carousel-item active" style="background-image:url(assets/img/faculty.jpg)">
