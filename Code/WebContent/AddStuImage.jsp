          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="well-left">
              <div class="single-well">
                <a href="#">
                <center><strong><h4 style="color:black;">Add Student Image</h4></strong></center>
                </a>
                 <form action="StuImageServlet" method="post" enctype="multipart/form-data">
           
          
           
           
            <input type="text" name="rollno" class="form-control" id="rollno"   placeholder="enter your roll no" required><br>
            <input type="file" name="file" class="form-control" id="file"   placeholder="enter password" required required pattern="^\d{8}$" title="10 numeric characters only"><br>
            <br><div class="text-center">
