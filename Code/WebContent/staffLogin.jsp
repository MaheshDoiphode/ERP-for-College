        ...
        <div class="row">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="well-left">
              <div class="single-well">
                <a href="#">
                  <img src="assets/img/fac12.jpg" alt="">
                </a>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="well-middle">
              <div class="single-well">
                <a href="#">
                  <center><strong><h4 style="color:#0000a4;">FACULTY LOGIN</h4></strong></center>
                </a>
                 <form action="StaffLoginServlet" method="post">
           
          
            <input type="text" name="teacher_id" class="form-control" id="teacher_id"   placeholder="enter your id" required>
            <br>
           <input type="password" name="pass" class="form-control" id="pass"   placeholder="enter password" required>
            <br><div class="text-center">
                <button class="button" button name="login"  type="submit" value="login">login</button>
                 <a href="changePassword1.jsp" style="color:red">    Change Password ?</a><br><br>
                <!--     <button class="button" button name="reset"  type="reset" >Cancel</button><br><br> -->
                  <!--  <p ><b><i>New Account Here?</b><a href="staffRegister.jsp" style="color:#0000a4;">Click On Register</a></i></p> -->
