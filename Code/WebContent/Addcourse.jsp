...
<br><br><br><br>
          <div class="carousel-item active" style="background-image:url(assets/img/cou.jpg)">
            <div class="carousel-container">
              <div class="container">
                ...
                <a href="#about" class="btn-get-started scrollto animate__animated animate__fadeInUp">Add Course </a>
              </div>
            </div>
          </div> 
     ...
     <!--  <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="icon-box" data-aos="fade-up">
             <h4 style="color:#282852">Add Course</h4><br>
                 <form action="CourseServlet" method="post" >
           
          <input type="text" name="course_id" class="form-control" id="course_id"  placeholder="Enter course Id" required><br>
            <input type="text" name="courname" class="form-control" id="courname"  placeholder="Enter course Name" required><br>
