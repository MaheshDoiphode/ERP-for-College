    ...
    <div class="container d-flex justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a href="Student.jsp"><span>Dashboard</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
             <!--  <li><a href="#">Drop Down 1</a></li> -->
              <!-- <li class="dropdown"><a href="#"><span>All Books</span></a> -->
                 <li><a href="studleave.jsp">Add Leave Request</a></li>
                <!--  <li><a href="studleave.jsp">View Subject Details</a></li> -->
                 <li><a href="ViewStuAttend.jsp">View attendance</a></li>
            </ul>
          </li>
          
          <li class="dropdown"><a href="Student.jsp" class="img-fluid"><img src="assets/img/bg.png" alt="" ><span>Notification</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
             <!--  <li><a href="#">Drop Down 1</a></li> -->
              <!-- <li class="dropdown"><a href="#"><span>All Books</span></a> -->
                 <li><a href="ViewStudLeave.jsp">View leave  details</a></li>
                 <li><a href="ViewUserFine.jsp">View fine details</a></li>
                  <li><a href="viewnotice.jsp">View Notice details</a></li>
                    <li><a href="viewtimetable.jsp">View timetable details</a></li>
                <!--  <li><a href="studleave.jsp">View attendance</a></li> -->
            </ul>
          </li>
          
          
          
           <!-- <li><a class="nav-link scrollto active" href="subjectDetails.jsp">subjectDetails</a></li> -->
           <!-- <li><a class="nav-link scrollto active" href="Notification.jsp" class="img-fluid"><img src="assets/img/bg.png" alt="" >Notification</a></li>
         ...
         <li class="dropdown">
          <a style="color:white;"><img src="assets/img/user.png" alt=""  class="rounded-circle">Welcome<%response.setContentType("text/html");  
...
<br><br><br><br>
          <div class="carousel-item active" style="background-image:url(assets/img/userhome.jpg)">
