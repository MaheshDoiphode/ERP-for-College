...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex justify-content-between">
      ...
      <div class="logo">
        <h1><a href="index.html"><span>College</span>System</a></h1>
    ...
    <div class="hero-container">
      <div id="heroCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background-image: url(assets/img/home1.jpg)" style="width:100%; height:500px;">
            <div class="carousel-container">
              <div class="container">
               
                <p class="animate__animated animate__fadeInUp" style="color:#979700">WELCOME TO ONLINE VETMEDS</p>
                 <h2 class="animate__animated animate__fadeInDown" style="color:#d8d8d8">Animal Health, is an exclusive innovation driven veterinary pharmaceutical company based at Pune, MH, India. We manufacture and market high-quality Medicines for Canine and Feline segment. </h2>
                <a href="#about" class="btn-get-started scrollto animate__animated animate__fadeInUp">Get Started</a>
              </div>
            </div>
          </div>

          <div class="carousel-item" style="background-image: url(assets/img/healthcare.jpg)">
            <div class="carousel-container">
              <div class="container">
              
             <p class="animate__animated animate__fadeInUp" style="color:#7d7dff">VISION</p>
                 <h2 class="animate__animated animate__fadeInDown" style="color:#d8d8d8">To improve the health and wellness of companion animal by providing innovative Animal Healthcare products with the highest levels of quality, safety  efficacy. To create the leading personalized pet experience by offering great products, expert advice, and connections to local pet service providers, all tailored to our customers needs. </h2>
          ...
          <div class="carousel-item" style="background-image: url(assets/img/home4.jpg)">
            <div class="carousel-container">
              <div class="container">
              <p class="animate__animated animate__fadeInUp" style="color:#ffaa55">VALUES</p>
                <h2 class="animate__animated animate__fadeInDown" style="color:#d8d8d8" >At Online Vetmeds, we believe in being M-Marketable, E- Ethical, D-Diversified Portfolio , F-Flexible, L- Leader & Y- Youthful</h2>
        ...
        <div class="container"> 
				<div class="row">
					<div class="col-md-12">
						<div class="col-lg-12">
							...
							<br><br>
							<h2><b>View Computer Department Details</b></h2>
						<br><br>
							</div>
						</div>
            ...
            <!--         <div style="margin-left:100px;margin-right:20px"> -->
                    <table class="table table-bordered" style="color:black">
                     ...
                     ResultSet rs=st.executeQuery("select * from purchase_details where email='"+email+"'");
                     //while(rs.next())
                     if(rs.next() == false) {
                    	%>
                    	...
                    	<%--  <td><img alt="Profile Pic" class="img-circle" src="rowpic.jsp?id=<%=rs.getInt(1) %>"  width="70px" height="50px"/></td> --%>
                    	...
                    	<%-- <td style="color:black"><%=rs.getString(16) %></td>   --%>
                    	  <%-- <td><a href="DeleteRowMaterialCon?id=<%=rs.getInt(1)%>" style="color:red;"><b>Delete</b></a></td> --%>
                    	 <td><a href="FundCollectServlet?id=<%=rs.getInt(1)%>&statusss=<%=rs.getString(16)%>"><%=rs.getString(16)%></a></td> 
                    	<%--   <td><a href="DeliveryStatus?id=<%=rs.getInt(1)%>&status=<%=rs.getString(14)%>"><%=rs.getString(14)%></a></td>  --%> 
                    	 </TR>                    	 
                    <%count++; }while(rs.next());}%> 
               ...
               <!-- <div class="form-group mt-1">
                ...
                <input type="text"  class="form-control" name="bankacc" id="bankacc" placeholder="Enter Your bank account number" required></textarea>
              </div>
              
              <div class="form-group mt-1">
            
                <input type="text"  class="form-control" name="ifscode" id="ifscode" placeholder="Enter Your bank IFSC code " required></textarea>
              </div> -->
