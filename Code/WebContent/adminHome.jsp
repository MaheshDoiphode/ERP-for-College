    ...
    <div class="container d-flex justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto active" href="Student.jsp">Student Details</a></li>
           <li><a class="nav-link scrollto active" href="Faculty.jsp">Faculty Details</a></li>
            <li class="dropdown"><a href="Student.jsp"><span>course & subject Details</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
             <!--  <li><a href="#">Drop Down 1</a></li> -->
              <!-- <li class="dropdown"><a href="#"><span>All Books</span></a> -->
                 <li><a href="Addcourse.jsp">Add Course </a></li>
                  <li><a href="viewcourse.jsp">View Course Details</a></li>
                   <li><a href="addsubject.jsp">Add subject </a></li>
                  <li><a href="viewsubject.jsp">View subject Details</a></li>
                  <li><a href="Timetable.jsp">TimeTable</a></li>
            </ul>
          </li>
          
          <!--  <li class="dropdown"><a href="Student.jsp"><span>Subject Details</span> <i class="bi bi-chevron-down"></i></a> -->
            <ul>
             <!--  <li><a href="#">Drop Down 1</a></li> -->
              <!-- <li class="dropdown"><a href="#"><span>All Books</span></a> -->
           ...
           <li><a class="nav-link scrollto active" href="Notification.jsp">Add Notification</a></li>
         ...
         <!--  <li><a class="nav-link scrollto active" href="addFaculty.jsp">Add Faculty</a></li> -->
          <li class="dropdown">
