  ...
  <main id="main">
    ...
    <div id="about" class="about-area area-padding">
      <div class="container">
       ...
       <br> <br> <br> <br> <br>
 <center><h2><strong> View Subject Details:</strong></h2></center>
                     ...
                     if(rs.next() == false) {
                    	...
                    	do{	 
                    	 ...
                    	 <!--  <th>id</th> -->
		                  ...
		                  <%}%>
                    	 <tr>
                    	<%-- <td><img alt="Profile Pic" class="img-circle" src="leavepic.jsp?id=<%=rs.getInt(1) %>"  width="100px" height="80px"/></td> 
                    	 --%>
