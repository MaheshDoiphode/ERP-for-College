          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="well-left">
              <div class="single-well">
                <a href="#"><br>
                <center><strong><h4 style="color:black;">ADD FACULTY</h4></strong></center>
                </a>
                 <form action="newFacultyServlet" method="post" enctype="multipart/form-data">
           
          
            <input type="text" name="name" class="form-control" id="name"  placeholder="Enter New Faculty Name" required><br>
              ...
              <input type="text" name="subject" class="form-control" id="subject"  placeholder="Enter Your subject" required><br> 
            ...
            <input type="text" name="teacher_id" class="form-control" id="teacher_id"   placeholder="enter your id" required><br>
             <input type="file" name="file" class="form-control" id="file"   placeholder="enter your id" required><br>
