  ...
  <!-- ======= hero Section ======= -->
   ...
   <div class="container">
						...
						<div class="col-lg-12">
							...
							<br><br>
							<h2><b>View computer student Details</b></h2>
						<br><br>
							</div>
						</div>
            ...
            <!--         <div style="margin-left:100px;margin-right:20px"> -->
                   ...
                   /*   HttpSession ss=request.getSession();
           			String email=(String)ss.getAttribute("branch"); */
                     Connection con=DBconnection.getConnection();
                     Statement st=con.createStatement();
                     ResultSet rs=st.executeQuery("select * from stud_reg where branch='Computer'");
                     //while(rs.next())
                     if(rs.next() == false) {
                    	%>
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <!--         <div style="margin-left:100px;margin-right:20px"> -->
                   ...
                   /*   HttpSession ss=request.getSession();
                     ...
                     Connection con=DBconnection.getConnection();
                     Statement st=con.createStatement();
                     ResultSet rs=st.executeQuery("select * from stu_reg where branch='Computer'");
                     //while(rs.next())
                     if(rs.next() == false) {
                    	%>
                    	<h4><b>No Users Present</b></h4>
