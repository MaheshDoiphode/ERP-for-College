      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link scrollto active" href="adminHome.jsp">Back</a></li>
           <li class="dropdown"><a href="Student.jsp"><span>Fill Student Details</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
             <!--  <li><a href="#">Drop Down 1</a></li> -->
              <!-- <li class="dropdown"><a href="#"><span>All Books</span></a> -->
                 <li><a href="studentRegister.jsp"> Student Register</a></li>
                   <li><a href="fineForm.jsp">Add fine student details</a></li> 
            </ul>
          </li>
          
          <li class="dropdown"><a href="Student.jsp"><span>View Student Details</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
             <!--  <li><a href="#">Drop Down 1</a></li> -->
              <!-- <li class="dropdown"><a href="#"><span>All Books</span></a> -->
              <li><a href="ViewStudentDetails.jsp">View Student Register details</a></li>
                 <li><a href="ViewStuLeaveAdmin.jsp">View student Leave request</a></li>
                  <li><a href="viewFineDetails.jsp">View Student Fine details</a></li>
                  <li><a href="viewattendance.jsp">View Student Attendance details</a></li>
            </ul>
          </li>
          ...
          <a style="color:white;"><img src="assets/img/user.png" alt=""  class="rounded-circle"><%response.setContentType("text/html");  
				 HttpSession sessio=request.getSession(true);  
	               ...
	               String email=(String)session.getAttribute("email");  
	                out.print(" "+email+""); }   %></a>
	                <ul><li class="dropdown"><a class="nav-link scrollto" href="home.jsp" style="color:black;">Logout</a></li>
          
          
          
          <!-- <li><a class="nav-link scrollto" href="studentRegister.jsp">Add Student Details</a></li>
          <li><a class="nav-link scrollto" href="studleave.jsp">Add Student leave Details</a></li> -->
          <!--  <li><a class="nav-link scrollto" href="ViewStudentDetails.jsp"  class="img-fluid"><img src="assets/img/bg.png" alt="">View Notification</a></li> -->
...
<br><br><br><br>
          <div class="carousel-item active" style="background-image:url(assets/img/studentimage.png)">
