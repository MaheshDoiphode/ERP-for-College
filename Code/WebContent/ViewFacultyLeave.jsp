  ...
  <main id="main">
    ...
    <div id="about" class="about-area area-padding">
      <div class="container">
       ...
       <br> <br> <br> <br> <br>
 <center><h2><strong> Staff leave Details:</strong></h2></center>
 ...
 <!--  <table class="table table-bordered" style="color:black border-spacing:0 5px;" > -->
  ...
  Connection con=DBconnection.getConnection();
                    ...
                    /*  ResultSet rs=st.executeQuery("select farmer_reg.id,bankdetails.bankholdername from  farmer_reg inner join bankdetails on farmer_reg.email=bankdetails.email"); */
                     ResultSet rs=st.executeQuery("select * from staffleave where name='"+name+"'");
                    //while(rs.next())
                     if(rs.next() == false) {
                    	%>
                    	...
                    	do{	 
                    	 ...
                    	 <th>Leave hard copy</th>
		                  ...
		                  <%}%>
                    	 <tr>
                    	 <td><img alt="Profile Pic" class="img-circle" src="staffleavepic.jsp?id=<%=rs.getInt(1) %>"  width="100px" height="80px"/></td> 
                     ...
                     <td style="color:black"><%=rs.getString(13) %></td>  --%>
                    	 ...
                    	 <th><a href="statusstaffleave?id=<%=rs.getInt(1)%>&status=<%=rs.getString(8)%>"><%=rs.getString(8)%></a></th>
