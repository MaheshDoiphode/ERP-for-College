...
<br><br><br><br>
          <div class="carousel-item active" style="background-image:url(assets/img/subadd.jpg)">
            <div class="carousel-container">
              <div class="container">
                ...
                <a href="#about" class="btn-get-started scrollto animate__animated animate__fadeInUp">Add Subject Details </a>
              </div>
            </div>
          </div> 
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="icon-box" data-aos="fade-up">
             <h4 style="color:#282852">Add Subject</h4><br>
                 <form action="SubjectServlet" method="post" >
           
          <input type="text" name="course_id" class="form-control" id="course_id"  placeholder="Enter course Id" required><br>
          <input type="text" name="sub_id" class="form-control" id="sub_id"  placeholder="Enter subject Id" required><br>
            <input type="text" name="subname" class="form-control" id="subname"  placeholder="Enter subject Name" required><br>
            ...
            <select type="text" name="year" class="form-control" placeholder="Year">
											...
											<option style="background-color: white">Final Year</option>
											 ...
											 <select type="text" name="sem" class="form-control" placeholder="sem">
											<option style="background-color: white">Select Sem</option>
											...
											<option style="background-color: white">VIII Sem</option>
											</select></br>
            
                <button class="button"  name="submit"  type="submit" value="submit">Added</button>
     ...
     <!--  <div class="container">
        ...
        <div class="col-xl-2 col-lg-7" data-aos="fade-right">
           <!--  <button class="button"><a href="viewuserregister.jsp"><b> View All User Details</b></a></button> -->
          ...
          <div class="text-center">
           ...
           <button class="button"><a href="viewuserregister.jsp"><b> View computer student details</b></a></button>
         ...
         <center><img src="assets/img/abc.jpg" class="img-fluid" alt="" style="margin-right: 70px"></center>
         <!-- <button class="button"><a href="viewuserregister.jsp"><b> View All User Details</b></a></button>
          <center><img src="assets/img/abc.jpg" class="img-fluid" alt="" style="margin-right: 70px"></center> -->
          <!--  <button class="button"><a href="ViewNotification.jsp"><b> View All Users Scheme Status</b></a></button> -->
