  ...
  <main id="main">
    ...
    <div id="about" class="about-area area-padding">
      <div class="container">
       ...
       <br> <br> <br> <br> <br>
 <center><h2><strong> Staff Register Details:</strong></h2></center>
                    ...
                    //while(rs.next())
                     if(rs.next() == false) {
                    	...
                    	<!--  <th>Student profile</th> -->
		                  ...
		                  <%}%>
                    	 <tr>
                    	<%--  <td><img alt="Profile Pic" class="img-circle" src="profilepicstu.jsp?id=<%=rs.getInt(1) %>"  width="100px" height="80px"/></td> --%> 
...
<%--                     	<td style="color:black"><%=rs.getString(10) %></td>  --%> 
                     ...
                     <td style="color:black"><%=rs.getString(13) %></td>  --%> 
                    	...
                    	<%--  <th><a href="statusstaffleave?id=<%=rs.getInt(1)%>&status=<%=rs.getString(11)%>"><%=rs.getString(11)%></a></th> --%>
