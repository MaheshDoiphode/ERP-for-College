...
<body>
    ...
    <div class="hero-container">
      ...
      <!--   <ol id="hero-carousel-indicators" class="carousel-indicators"></ol> -->
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background-image:url(assets/img/fac.jpg)">
            <div class="carousel-container">
              <div class="container">
               <h2 class="animate__animated animate__fadeInDown">FIRST YEAR (COMPUTER DEPT)</h2>
              <table>
 
  <tr>
    <th style="background-color:black">SUB_ID</th>
    <th style="background-color: black">SUBJECT NAME</th>
    <th style="background-color: black">SUBJECT TEACHERNAME</th>
    <th style="background-color: black">VIEW SUBJECT AND FACULTY DETAILS</th>
  </tr>
  
  <tr>
    <td style="text-color:white" >001</td>
    <td>COMPUTER DEPARTMENT</td>
     <td>ANUJA PADVAL(B.TECH)</td>
  	<td><a href="deptDetails.jsp"  ><center><b>COMP  DEPT VIEW DETAILS</b></center></a></td>
 </tr>
  
  <tr>
   <td>002</td>
   <td>INFORMATION TECHNOLOGY</td>
   <td>VINOD KAMBLE  (M.TECH)</td>
  <td><a href="#myModal2" data-toggle="modal" ><center><b> IT DEPT VIEW DETAILS</b></center></a></td>
  </tr>
  
  <tr>
   <td>003</td>
   <td>ELECTRONICS AND TELECOMMUNICATION</td>
   <td>PRADIP SHINDE  (M.TECH)</td>
  <td><a href="#myModal3" data-toggle="modal" ><center><b> ENTC DEPT VIEW DETAILS</b></center></a></td>
  ...
  <tr>
   <td>004</td>
   <td>CIVIL</td>
   <td>MAHESH BODAKE  (B.TECH)</td>
  <td><a href="#myModal3" data-toggle="modal" ><center><b> CIVIL DEPT VIEW DETAILS</b></center></a></td>
  ...
  <tr>
   <td>005</td>
   <td>MECHANICAL</td>
   <td>DEEPAK AGARWAL(B.TECH)</td>
  <td><a href="#myModal3" data-toggle="modal" ><center><b> MECH VIEW DETAILS</b></center></a></td>
