  ...
  <main id="main">
    ...
    <div id="about" class="about-area area-padding">
      <div class="container">
       ...
       <br> <br> <br> <br> <br>
 <center><h2><strong> User leave Details:</strong></h2></center>
  ...
  HttpSession ss=request.getSession();
	String name=(String)ss.getAttribute("name");
                    ...
                    /*  ResultSet rs=st.executeQuery("select farmer_reg.id,bankdetails.bankholdername from  farmer_reg inner join bankdetails on farmer_reg.email=bankdetails.email"); */
                     ResultSet rs=st.executeQuery("select * from stuleave  where name='"+name+"'");
                    //while(rs.next())
                     if(rs.next() == false) {
                    	%>
                     ...
                     <td style="color:black"><%=rs.getString(13) %></td>  --%>
                    	 ...
                    	 <th><a href="StuLeaveStatus?id=<%=rs.getInt(1)%>&status=<%=rs.getString(9)%>"><%=rs.getString(9)%></a></th> 
