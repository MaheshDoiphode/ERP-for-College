        ...
        <div class="row">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="well-left">
              <div class="single-well">
                <!-- <a href="#"> -->
                  <img src="assets/img/studentlogin12.png" alt=""><img src="assets/img/login.jpg" alt="">
                </a>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="well-middle">
              <div class="single-well">
              <!--   <a href="#"> -->
                  <center><strong><h4 style="color:#6f3700;">STUDENT LOGIN</h4></strong></center>
                </a>
                 <form action="StudentLoginServlet" method="post">
           
          
            <input type="text" name="rollno" class="form-control" id="rollno"   placeholder="enter your roll no" required>
            <br>
           <input type="password" name="pass" class="form-control" id="pass"   placeholder="enter password" required>
            <br><div class="text-center">
                <button class="button" button name="login"  type="submit" value="login">Login</button>
                <a href="changePassword.jsp" style="color:red">    Change Password ?</a><br><br>
                    <!-- <button class="button" button name="reset"  type="reset" >Cancel</button><br><br> -->
                  <!--  <p ><b><i>New Account Here?</b><a href="studentRegister.jsp" style="color:#6f3700;">Click On Register</a></i></p> -->
