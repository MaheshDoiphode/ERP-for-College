...
<br><br><br><br>
          <div class="carousel-item active" style="background-image:url(assets/img/Leaveapplication.jpg)">
            <div class="carousel-container">
              <div class="container">
                ...
                <a href="#about" class="btn-get-started scrollto animate__animated animate__fadeInUp">Fill Out Leave Request Form</a>
              </div>
            </div>
          </div> 
     ...
     <!--  <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="icon-box" data-aos="fade-up">
             <h4 style="color:#282852">Staff Leave Application</h4><br>
                 <form action="StaffLveServlet" method="post" enctype="multipart/form-data">
           
          
            <input type="text" name="name" class="form-control" id="name"  placeholder="Enter staff Name" required><br>
            <input type="text" name="teacher_id" class="form-control" id="teacher_id"  placeholder="Enter your teacher id" required><br>
              <!-- <input type="text" name="lvetyp" class="form-control" id="lvetyp"  placeholder="Enter Your leave type" required><br> -->
              <select type="text" name="lvetyp" id="lvetyp" class="form-control">
											<option style="background-color: white">sick leave</option>
											<option style="background-color: white">emergency leave</option>
											<option style="background-color: white">casual leave</option>
		</select>  <br>
		<label class="form-control"  > Enter your Leave period date:
				<input type="date" name="lvedtesrt" class="form-control" id="lvedtesrt"  placeholder="Enter your leave date to " required><br> 
				<input type="date" name="lvedtend" class="form-control" id="lvedtend"  placeholder="Enter your leave date from" required><br> </label><br>					
				 <input type="text" name="msg" class="form-control" id="msg"  placeholder="Enter your leave reason" required><br>							
				<!-- <input type="text" name="teachnm" class="form-control" id="teachnm"  placeholder="Enter your class teachername " required><br> -->
				<label class="form-control"  >Attached your leave application  hard copy with sign:
				<input type="file" name="file" class="form-control" id="file"  placeholder="Attached your leave Application hardcopy " required><br></label><br>
				<div class="text-center">
                <button class="button"  name="submit"  type="submit" value="submit">Send Leave Application</button>
