    ...
    <div class="container d-flex justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="userLogin.jsp">Student</a></li>
          <li><a class="nav-link scrollto" href="mechanic.jsp">faculty</a></li>
    ...
    <div class="hero-container">
      <div id="heroCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background-image: url(assets/img/admin12.jpg)">
        ...
        <div class="row">
           <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="well-left">
              <div class="single-well">
                <a href="#">
                  <img src="assets/img/forget123.jpg" alt="">
                </a>
              </div>
            </div>
          </div> 
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="well-middle">
              ...
              <br><br> <br><br><br><br>
              <!--   <a href="#"> -->
          <!--  <center><img src="assets/img/pwdchange.png" alt="">  -->      <center><strong><h4 style="color:#6f3700;">Forgot Password</h4></strong></center>
        <form action="changePasswordStaffServlet" method="post">
           <input type="password" name="oldpass" class="form-control" id="newpass"   placeholder="enter your old password" required>
            <br>
           <input type="password" name="newpass" class="form-control" id="oldpass"   placeholder="enter your new password" required>
            <br><div class="text-center">
                <button class="button" button name="login"  type="submit" value="changepassword">submit</button>
                <!-- <!--  <a href="StudentForgotPassword.jsp" style="color:red">    Forgot Password ?</a><br><br>
                    <button class="button" button name="reset"  type="reset" >Cancel</button><br><br>
                   <p ><b><i>New Account Here?</b><a href="garageRegister.jsp" style="color:#0000a4;">Click On Register</a></i></p> -->
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="well-left">
              <div class="single-well">
                <a href="#">
                  <img src="assets/img/adminlogin.jpg" alt="">
                </a>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="well-middle">
              <div class="single-well">
                <a href="#">
                  <h4 class="sec-head">ADMIN LOGIN PORTAL</h4>
           ...
           <input type="password" name="pass" class="form-control" id="pass"   placeholder="enter password" required>
            <br><div class="text-center">
                <button class="button"  name="login"  type="login" value="login">LOGIN</button></div>
                    <button class="button" button name="reset"  type="reset" >Cancel</button><br><br>
                   <p ><b><i>New Account Here?</b><a href="UserRegister.jsp" style="color:#0000a4;">Click On Register</a></i></p>
