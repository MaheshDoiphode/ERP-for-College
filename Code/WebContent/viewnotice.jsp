                  ...
                  <h2><b>Notice</b></h2>
                   ...
                   <!--  <table class="table table-bordered" style="color:black" > -->
                    <table id="customers">
                     ...
                     if(rs.next() == false) {
                    	%>
                    	<h4 style="text-align:center;margin-right:70px"><b>No Users Present</b></h4>
                    	<%
                     }
                    else{
                    	int count=0;
                    	do{	 
                    	 if(count == 0) {	
                    	 %>
                    	<!--  <tr  class="danger" style="color:black; width:80%"; background-color:yellow"; > -->
                     		<th style="background-color: #800040">Id</th>
		           <!--   <th style="background-color: #800040">User Name</th> -->
		                   <!-- <th style="background-color: #800040">Age</th>
		                     <th style="background-color: #800040">Gender</th>
		                     <th style="background-color: #800040">Location</th>
		                     <th style="background-color: #800040">Height</th>
		                     <th style="background-color: #800040">Bodytype</th>
		                     <th style="background-color: #800040">Complexion</th>
		                     <th style="background-color: #800040">Experience</th>
		                     <th style="background-color: #800040">passport</th>
		                      <th style="background-color: #800040">Language</th>
		                     <th style="background-color: #800040">Phone No</th>
		                      <th style="background-color: #800040">Email</th> -->
		                     <td style="background-color: #800040">Delete</td>
		                      
		                  </tr>
		                  <%}%>
                    	 <TR>
                    	 <tr>
                    	 <td><img alt="Profile Pic" class="img-circle" src="noticepic.jsp?id=<%=rs.getInt(1) %>"  width="2000px" height="1000px"/></td> 
                    ...
                    <%-- 	 <td style="color:black"><%=rs.getString(2) %></td> --%>
                    	...
                    	<%--  <th><a href="UserStatusController?id=<%=rs.getInt(1)%>&status=<%=rs.getString(14)%>"><%=rs.getString(14)%></a></th> --%>
                    	 <th><a style="color:#aa0000" href="DeleteServlet?id=<%=rs.getInt(1)%>"><b>Delete</b></a></th>
                    	 </TR>                    	 
                    <%count++; }while(rs.next());}%> 
