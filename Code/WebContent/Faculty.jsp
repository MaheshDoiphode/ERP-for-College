...
<nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link scrollto active" href="adminHome.jsp">Back</a></li>
           <li class="dropdown"><a href="Student.jsp"><span>Fill Staff Details</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
             <!--  <li><a href="#">Drop Down 1</a></li> -->
              <!-- <li class="dropdown"><a href="#"><span>All Books</span></a> -->
               <li><a href="staffRegister.jsp"> Faculty Register</a></li>
                 <li><a href="addFaculty.jsp">Assign New Faculty</a></li>
                 <!--  <li><a href="staffleave.jsp">Add Staff leave Details</a></li> -->
            </ul>
          </li>
          
          <li class="dropdown"><a href="Student.jsp"><span>View Staff Details</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
             <!--  <li><a href="#">Drop Down 1</a></li> -->
              <!-- <li class="dropdown"><a href="#"><span>All Books</span></a> -->
                 <li><a href="viewstaffreg.jsp">View staff Register Details</a></li>
                  <li><a href="viewsubjectassign.jsp">view new assign staff</a></li>
                   <li><a href="viewstaffleave.jsp">view faculty leave Request</a></li>
            </ul>
          </li>
...
<br><br><br><br>
          <div class="carousel-item active" style="background-image:url(assets/img/stf.jpg)">
            <div class="carousel-container">
              <div class="container">
                <!-- <h1 class="animate__animated animate__fadeInDown" style="color:white">Our Faculty</h1> -->
